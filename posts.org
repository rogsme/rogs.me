...
** How I got Claude certified (and how you can too) :claude:certification:ai:career:
:PROPERTIES:
:EXPORT_FILE_NAME: how-i-got-claude-certified
:EXPORT_DATE: 2026-07-19
:ID:       c3e7a1f0-2b4d-4e6a-9c8f-1a2b3c4d5e6f
:END:

[[/claude-cert-badge.png]]

I'm [[https://www.credly.com/badges/6ff376d3-498d-4792-b90b-cc06bc863965/linked_in?t=thryci][Claude Certified Architect - Foundations]] now. Look at me.
...
The thing I liked most about it is that it teaches you to /recognize/ the pitfalls the exam throws at you, without spoon-feeding you exactly what they are. So instead of memorizing "the answer is X," you build the instinct to spot what's going on. My friend from work, Reed, described this as "instinct training," which nails it. I prefer that. It stuck better.
...
:PROPERTIES:
:ID:       e5f9c3b2-4d6f-4a8c-9e0b-3c4d5e6f7081
:END:
...
:PROPERTIES:
:ID:       f6a0d4c3-5e7f-4b9d-8f1c-4d5e6f708192
:END:
...
:PROPERTIES:
:ID:       a7b1e5d4-6f8a-4c0e-9a2d-5e6f70819203
:END:
...
One important caveat, which Reed pointed out after taking the exam: this is a tie-breaker, not an absolute rule. He remembers questions testing when /not/ to use Claude too. Read the constraints first, and don't blindly pick Claude if the scenario suggests it isn't appropriate. "Let Claude do it" only helps when the remaining answers are otherwise equally sound.

*** The exam-day logistics nobody warns you about
:PROPERTIES:
:ID:       b8c2f6e5-7a9b-4d1f-8b3e-6f7081920314
:END:
...
:PROPERTIES:
:ID:       c9d3a7f6-8b0c-4e2a-9c4f-708192031425
:END:
...
:END:
All posts in here will have the category set to /gaming/.
** Running Fallout London on Bazzite :linux::gaming::fallout::bazzite:
:PROPERTIES:
:EXPORT_FILE_NAME: running-fallout-london-on-bazzite
:EXPORT_DATE: 2026-06-10
:ID:       f1a2b3c4-d5e6-7890-abcd-ef0987654321
:END:

I'm a huge Fallout fan, and [[https://www.falloutondon.com/][Fallout London]] is one of the most impressive mods I've seen in years: a
full DLC-sized expansion set in post-apocalyptic London, made by a community team. Running it on
[[https://bazzite.gg/][Bazzite]] (my gaming OS of choice) wasn't completely straightforward, so here's what actually worked for
...
- [[https://bazzite.gg/][Bazzite]] installed on your machine
- [[https://heroicgameslauncher.com/][Heroic Games Launcher]]
...
:PROPERTIES:
:ID:       007517b4-cb69-4bc4-8f9b-092dbc9c2a0f
:END:

If you don't have it yet, install [[https://heroicgameslauncher.com/][Heroic]] from the Bazzite app store or via Flatpak. It's a fantastic
...
#+ATTR_HTML: :alt Heroic Games Launcher main screen
[[/fallout-london-heroic.png]]

**** 2. Install the Fallout London One Click Mod
:PROPERTIES:
:ID:       6ddc698d-f25e-4e7c-bdc9-872a86e54ef5
:END:
...
#+ATTR_HTML: :alt Fallout London in Heroic Games Launcher
[[/fallout-london-install.png]]

**** 3. Disable UMU (yes, it needs to be disabled)
:PROPERTIES:
:ID:       6fd3a8ef-2497-4e2f-b8b5-39204831d204
:END:
...
#+ATTR_HTML: :alt Heroic advanced settings showing Disable UMU option
[[/fallout-london-umu.png]]

**** 4. Run it once in Desktop Mode
:PROPERTIES:
:ID:       b70e3ad8-f27e-4e51-9afb-a687b462d1f3
:END:
...
**** 5. Add to Steam
:PROPERTIES:
:ID:       1e9d008c-ef4b-4c99-8fc4-fd33b99aa7bc
:END:
...
#+ATTR_HTML: :alt Adding Fallout London to Steam via Heroic
[[/fallout-london-steam.png]]

*** Play!
:PROPERTIES:
:ID:       08405d9a-8da2-459c-8a30-32c6a70810ae
:END:
...
#+ATTR_HTML: :alt Fallout in Steam
[[/fallout-london-playing-1.png]]

#+ATTR_HTML: :alt Fallout London title screen
[[/fallout-london-playing-2.jpg]]
